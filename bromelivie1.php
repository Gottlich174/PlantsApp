...
$links = array(
    ...
    "Хедера(Плющ комнатный)"=>"xedera.php",
    ...
    "Фуксия"=>"fuksiya.php",
    "Абутилон(комнатный клен)"=>"abutilon.php",
    "Хойя(Восковой плющ)"=>"hoiya.php",
    "Зебрина"=>"zebrina.php",
...
$url = 'https://rastenievod.com/category/komnatnye-rasteniya/bromelievye'; //нужно указывать точный адрес к странице!!!
...
<div style="font-size: 130%; position: absolute; top: 1%; right: 1%; color: black;"><b>Категория "Бромелиевые"</b></div>
