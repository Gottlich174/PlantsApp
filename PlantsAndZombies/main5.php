...
//Параметры подключения к исходной странице 17
...
//Параметры подключения к исходной странице 18
$url = 'https://rastenievod.com/category/komnatnye-rasteniya/page/2'; //нужно указывать точный адрес к странице!!!
...
//Параметры подключения к исходной странице 19
...
//Параметры подключения к исходной странице 20
$url = 'https://rastenievod.com/category/komnatnye-rasteniya/page/20'; //нужно указывать точный адрес к странице!!!
...
<div class="paginator">
    ...
    <a href="main5.php" style="text-decoration: underline;">5</a>
</div>
</body>
</html>