...
//Параметры подключения к исходной странице 5

$url = 'https://rastenievod.com/category/komnatnye-rasteniya/page/5'; //нужно указывать точный адрес к странице!!!
...
//Параметры подключения к исходной странице 6
$url = 'https://rastenievod.com/category/komnatnye-rasteniya/page/6'; //нужно указывать точный адрес к странице!!!
...
//Параметры подключения к исходной странице 7
$url = 'https://rastenievod.com/category/komnatnye-rasteniya/page/7'; //нужно указывать точный адрес к странице!!!
...
//Параметры подключения к исходной странице 8
$url = 'https://rastenievod.com/category/komnatnye-rasteniya/page/8'; //нужно указывать точный адрес к странице!!!
...
<div class="paginator">
    <a href="main.php">1</a>
    <a href="main1.php" style="text-decoration: underline;">2</a>
