...
//Параметры подключения к исходной странице 9

$url = 'https://rastenievod.com/category/komnatnye-rasteniya/page/9'; //нужно указывать точный адрес к странице!!!
...
//Параметры подключения к исходной странице 10
$url = 'https://rastenievod.com/category/komnatnye-rasteniya/page/10'; //нужно указывать точный адрес к странице!!!
...
//Параметры подключения к исходной странице 11
$url = 'https://rastenievod.com/category/komnatnye-rasteniya/page/11'; //нужно указывать точный адрес к странице!!!
...
//Параметры подключения к исходной странице 12
$url = 'https://rastenievod.com/category/komnatnye-rasteniya/page/12'; //нужно указывать точный адрес к странице!!!
...
<div class="paginator">
    ...
    <a href="main2.php" style="text-decoration: underline;">3</a>
    <a href="main3.php">4</a>
