...
//Параметры подключения к исходной странице 1

$url = 'https://rastenievod.com/category/komnatnye-rasteniya/page/1'; //нужно указывать точный адрес к странице!!!
...
//Параметры подключения к исходной странице 2
...
//Параметры подключения к исходной странице 3
$url = 'https://rastenievod.com/category/komnatnye-rasteniya/page/3'; //нужно указывать точный адрес к странице!!!
...
//Параметры подключения к исходной странице 4
$url = 'https://rastenievod.com/category/komnatnye-rasteniya/page/4'; //нужно указывать точный адрес к странице!!!
...
<div class="paginator">
    <a href="main.php" style="text-decoration: underline;">1</a>
