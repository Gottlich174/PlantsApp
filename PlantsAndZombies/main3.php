...
//Параметры подключения к исходной странице 13

$url = 'https://rastenievod.com/category/komnatnye-rasteniya/page/13'; //нужно указывать точный адрес к странице!!!
...
foreach ($html->find('.category-bromelievye') AS $post){
...
foreach ($html->find('.category-kaktusy') AS $post){
...
foreach ($html->find('.category-lukovichny') AS $post){
...
//Параметры подключения к исходной странице 14
$url = 'https://rastenievod.com/category/komnatnye-rasteniya/page/14'; //нужно указывать точный адрес к странице!!!
...
//Параметры подключения к исходной странице 15
$url = 'https://rastenievod.com/category/komnatnye-rasteniya/page/15'; //нужно указывать точный адрес к странице!!!
...
//Параметры подключения к исходной странице 16
$url = 'https://rastenievod.com/category/komnatnye-rasteniya/page/16'; //нужно указывать точный адрес к странице!!!
...
<div class="paginator">
    <a href="main.php">1</a>
    <a href="main1.php">2</a>
    <a href="main2.php">3</a>
    <a href="main3.php" style="text-decoration: underline;">4</a>
    <a href="main5.php">5</a>
</div>
</body>
</html>